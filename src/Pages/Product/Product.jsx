  ...
  return (
    <Box className="h-full overflow-auto pr-1">
      ...
      <Box className="grid grid-cols-1 gap-5 xl:grid-cols-[440px_1fr]">
        <Paper elevation={0} className="overflow-hidden rounded-2xl border border-slate-200 bg-white p-4">
          <Box className="flex aspect-square items-center justify-center overflow-hidden rounded-2xl border border-slate-200 bg-slate-50">
            {activeImage ? (
              ...
              <Avatar variant="rounded" sx={{ width: 110, height: 110, fontSize: 42, bgcolor: "#7F1D1D" }}>
          ...
          <Box className="mt-3 grid grid-cols-4 gap-2">
            {images.map((image) => (
              ...
              >
                <img src={getImageUrl(image.image_url)} alt={product.name} className="h-full w-full object-cover" />
              </Button>
            ))}
          </Box>
        </Paper>
        ...
        <Paper elevation={0} className="rounded-2xl border border-slate-200 bg-white p-5 sm:p-6">
            ...
            <>
              ...
              <Box className="my-4">
                ...
                {priceRows.length ? (
                  ...
                  <Alert severity="info">
                    Bu mahsulot uchun bo'lim narxlari hali topilmadi.
                  </Alert>
                )}
              </Box>
          ...
          <Box className="mt-3 rounded-2xl border border-slate-200 bg-slate-50 p-4">
            <Typography variant="body2" className="text-slate-500">Tavsif</Typography>
