...
const Products = () => {
    ...
    <Stack spacing={2} className="pt-2">
      ...
      <Box className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <TextField
          ...
          onChange={handleProductChange("color")}
        />
        <TextField
          label="Birlik"
  ...
  return (
    <Box className="flex h-full min-h-0 flex-col">
      ...
      >
        <Box className="flex items-start gap-3 justify-between">
          <Box className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-7">
            <TextField
              size="small"
              label="Qidirish"
              value={filters.q}
            ...
            <Button
              variant="outlined"
              onClick={() => fetchProducts(0, pageInfo.limit)}
            >
              Filterlash
            </Button>
          </Box>
      ...
      >
        ...
        <TablePagination
          ...
          onRowsPerPageChange={(event) =>
            fetchProducts(0, Number(event.target.value))
          }
      ...
      >
        ...
        <DialogActions>
          {selectedCategory && (
            <Button onClick={resetCategoryForm}>Tozalash</Button>
          )}
          <Button
            onClick={() => {
              setCategoryOpen(false);
